...
import com.tencongty.projectprm.fragments.AdminUserDetailActivity;
...
public class UserAdapter extends RecyclerView.Adapter<UserAdapter.UserViewHolder> {
    ...
    class UserViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(User user) {
            // In đậm phần tiêu đề
            userName.setText(formatLabelText("Tên người dùng: ", user.getName() != null ? user.getName() : "Không có tên"));
            userUsername.setText(formatLabelText("UserName: @", user.getUsername() != null ? user.getUsername() : "unknown"));
            userEmail.setText(formatLabelText("Email: ", user.getEmail() != null ? user.getEmail() : "Không có email"));
            userPhone.setText(formatLabelText("Số điện thoại: ", user.getPhone() != null ? user.getPhone() : "Chưa cập nhật"));
